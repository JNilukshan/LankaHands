...
import { getMockSellerStatsForNimali, getMockRecentOrdersForNimali } from '@/lib/mock-data';
...
export default function SellerDashboardPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      setIsLoading(true);
      // NOTE: These functions are still using mock data for "Nimali".
      // A real implementation would fetch data based on `currentUser.id`.
  ...
  if (isAuthLoading || isLoading || !stats || !currentUser) {
    return (
