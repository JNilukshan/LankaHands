...
import { getMockProductsByArtisanId } from '@/lib/mock-data';
...
export default function ManageProductsPage() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      setIsLoading(true);
      const sellerProducts = await getMockProductsByArtisanId(currentUser.id);
  ...
  if (isAuthLoading || isLoading) {
    return (
        <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-lg text-muted-foreground">Loading your products...</p>
        </div>
    );
  }
